...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 21 mars 2021 à 16:45
...
--
-- Base de données : `u916182205_gsb_frais`
--
CREATE DATABASE IF NOT EXISTS `u916182205_gsb_frais` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `u916182205_gsb_frais`;
...
('a01', 'Ballin', 'François', 'fball', 'bbfa0fc33f0d92af5eeb28a19d6a805ab0a6b19cafba1ada493c297641a07ad3');
...
('a131', '202101', 0, '863.12', '2021-03-03', 'VA'),
('a131', '202102', 1, '534.24', '2021-03-03', 'CL'),
('a131', '202103', 0, '0.00', '2021-02-25', 'CR'),
('a17', '202101', 1, '110.00', '2021-03-01', 'CL');
...
(2, 'a131', '202102', 'Fleurs', '2021-02-02', '20.00'),
(3, 'a131', '202103', 'REFUSER : Fleur', '2021-02-01', '112.00'),
(4, 'a131', '202103', 'champagne', '2021-03-01', '35.00');
